            ...
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row mb-5">
                  ...
                  <div class="col-md-6 text-right" id="total_1">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="monto ()">PAGAR</button>
                  </div>
                </div>
              </div>
            </div>
...
<html lang="en">
          ...
          <div class="col-md-6 pl-5">
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="monto ()">Proceed To Checkout</button>
                  </div>
                </div>
              </div>
            </div>
  ...
  <script src="js/aos.js"></script>
  <script src="js/main.js"></script>
  <script src="montopagar.js"></script>
  <script>
    $(document).ready(function(){
      $(".btnEliminar").click(function(event){
        event.preventDefault();
